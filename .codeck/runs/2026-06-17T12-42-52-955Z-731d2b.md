# Codeck Run 2026-06-17T12-42-52-955Z-731d2b
- Date: 2026-06-17T12:42:52.956Z
- Host: `cli`
- Mode: `ask`
- Executor: `gemini`
- Agent: `gemini`
...
## Task
```text
请基于当前仓库的 README.md，把它规范化成更像开源项目 README 的中文版本。要求：保留现有事实，不虚构功能；结构建议包含简介、特性、安装、快速开始、Codex MCP 接入、常用命令、Executor、配置、注意事项；语言更清晰克制；直接输出完整 README.md 内容，不要解释。
```
